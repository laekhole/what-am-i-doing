...
The files retain their original contents. Product names and marks belong to OpenAI and Anthropic respectively; waid's MIT license does not relicense these third-party marks. waid does not imply sponsorship or endorsement. Unknown harnesses use a generic terminal symbol and their supplied display name.
